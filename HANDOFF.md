...
- トップの公開記録を「進み具合」と「学びのメモ」の2レーンに分割
- 「学びのメモ」ではロードマップをStudy 01より前の最初の項目に配置
...
- 収益が出るまでは株の実取引には進まない
- トップ上では「Day記録 / Study学習」とは書かず、「進み具合 / 学びのメモ」として分ける
...
5. 学習記録の次回「株・市場・証券会社・証券口座の違い」を会話内で進める
6. 証券会社、証券口座、NISA、Prime市場などの制度・用語は、公開前に公式情報で確認する
7. 学習内容を公開用に整えて `study-investing-03.html` として追加する
...
- 証券会社は株を売買するための窓口
- 証券口座は株や投資信託を持つための口座
- Prime市場は証券会社や口座の種類ではなく、東京証券取引所の市場区分
- NISA口座は制度を使うための口座で、投資対象そのものではない
